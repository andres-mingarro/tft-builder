...
export const carryBuilds: CarryBuild[] = [
  ...
  },
  {
    ...
    image: '/tft-assets/champions/Fizz.png',
    role: 'Carry Flex',
    description: 'Bursteo a carry enemigo',
    isMain: false,
    items: [
  ...
  },
  {
    ...
    image: '/tft-assets/champions/Kennen.png',
    role: 'Tank / CC',
    description: 'Armadura + control de masas',
    isMain: false,
    items: [
...
export const tips: Tip[] = [
  ...
  { icon: '🛡️', text: 'Kennen con tanque + Ionic Spark shredea la MR del equipo enemigo para todo el daño AP.' },
